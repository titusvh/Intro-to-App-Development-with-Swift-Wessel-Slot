...
let TotalNumberOfAnimals = NumberOfDogs + NumberOfCats + NuberOfTurtles + NumberOfHamsters

// Total Number Of Mammals
let TotalNumberOfMammels = NumberOfDogs + NumberOfCats + NumberOfHamsters
